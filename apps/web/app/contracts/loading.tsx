      ...
      >
        <div className="relative">
          <motion.div
            ...
            className="w-20 h-20 rounded-2xl bg-gradient-to-br from-violet-500 via-violet-500 to-purple-500 flex items-center justify-center shadow-2xl shadow-violet-500/30"
          >
          ...
          >
            <div className="absolute -bottom-3 left-1/2 -translate-x-1/2 p-2 bg-white dark:bg-slate-800 rounded-lg shadow-md dark:shadow-slate-900/50">
              <FilePen className="h-4 w-4 text-violet-500" />
            </div>
          </motion.div>
