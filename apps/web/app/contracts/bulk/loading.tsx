      ...
      <div className="flex flex-col items-center">
        ...
        <div className="relative">
          <motion.div
            ...
            className="w-20 h-20 rounded-2xl bg-gradient-to-br from-teal-500 via-cyan-500 to-teal-600 shadow-2xl shadow-teal-500/30 flex items-center justify-center"
          >
