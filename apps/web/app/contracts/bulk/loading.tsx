...
import { Files, Copy, Layers, CheckCircle } from 'lucide-react';

export default function BulkContractsLoading() {
  return (
      ...
      <div className="flex flex-col items-center">
        ...
        <div className="relative">
          <motion.div
            ...
            className="w-20 h-20 rounded-2xl bg-gradient-to-br from-violet-500 via-purple-500 to-violet-600 shadow-2xl shadow-violet-500/30 flex items-center justify-center"
          >
        ...
        >
          <h2 className="text-xl font-semibold bg-gradient-to-r from-violet-600 to-purple-600 bg-clip-text text-transparent">
            Loading Bulk Contracts
          </h2>
          <p className="text-sm text-muted-foreground mt-1">Preparing your contracts...</p>
