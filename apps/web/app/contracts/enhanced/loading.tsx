...
import { FileText, Sparkles, Eye, Star } from 'lucide-react';

export default function EnhancedContractsLoading() {
  return (
      ...
      <div className="flex flex-col items-center">
        ...
        >
          <h2 className="text-xl font-semibold bg-gradient-to-r from-indigo-600 to-purple-600 bg-clip-text text-transparent">
            Loading Enhanced Contracts
          </h2>
          <p className="text-sm text-muted-foreground mt-1">Preparing enhanced view...</p>
