  ...
  if (variant === 'timeline') {
    return (
      <Card className={cn(detailUi.card, className)}>
        ...
        <CardContent className={cn(detailUi.cardContent, 'space-y-4')}>
        ...
        <CardContent className={cn(detailUi.cardContent, 'space-y-3')}>
          {[1, 2].map(i => (
            <motion.div
              ...
              animate={{ opacity: 1, y: 0 }}
              transition={{ delay: i * 0.1 }}
              className={cn(detailUi.fieldCell, 'flex-row items-start')}
            >
  ...
  if (variant === 'list') {
    return (
      <Card className={cn(detailUi.card, className)}>
        ...
        <CardContent className={cn(detailUi.cardContent, 'space-y-2')}>
          {Array.from({ length: lines }).map((_, i) => (
            <motion.div
              ...
              className={cn(detailUi.tileRow, 'p-2')}
            >
