...
import { FileText, Eye, Clock, Shield } from 'lucide-react';
      ...
      <div className="flex flex-col items-center">
        ...
        <div className="relative">
          <motion.div
            ...
            className="w-20 h-20 rounded-2xl bg-gradient-to-br from-teal-500 via-emerald-500 to-teal-600 shadow-2xl shadow-teal-500/30 flex items-center justify-center"
          >
        ...
        >
          ...
          <p className="text-sm text-muted-foreground mt-1">Fetching contract information...</p>
          ...
          <div className="flex justify-center gap-1 mt-4">
            {[0, 1, 2].map((i) => (
              <motion.div
                ...
                className="w-2 h-2 rounded-full bg-gradient-to-r from-teal-500 to-emerald-500"
              />
            ))}
          </div>
        </motion.div>
