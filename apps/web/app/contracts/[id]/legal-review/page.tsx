...
export default function LegalReviewPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-slate-50 via-indigo-50/30 to-purple-50/20 dark:from-slate-900 dark:via-indigo-950/30 dark:to-purple-950/20 flex items-center justify-center">
        <motion.div
        ...
        >
          <div className="relative">
            ...
            <Scale className="w-6 h-6 text-indigo-600 dark:text-indigo-400 absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2" />
          </div>
        ...
        {!review ? (
          ...
          <Card className="bg-white/80 dark:bg-slate-800/80 backdrop-blur-sm border-slate-200/50 dark:border-slate-700/50">
            <CardContent className="py-16 text-center">
              <div className="inline-flex items-center justify-center w-20 h-20 rounded-2xl bg-gradient-to-br from-indigo-500 to-purple-500 mb-6 shadow-xl shadow-indigo-500/30 dark:shadow-indigo-500/20">
              ...
              <Button
                ...
                disabled={analyzing || !contract?.rawText}
                size="lg"
                className="bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-700 hover:to-purple-700 gap-2 shadow-lg shadow-indigo-500/30"
              >
                {analyzing ? (
                  <>
                                ...
                                <div className="bg-indigo-50 dark:bg-indigo-950/30 rounded-lg p-4">
                                  ...
                                  <div className="space-y-3">
                                    {clause.playbookMatch.preferredText && (
                                      <div>
                                        <p className="text-xs font-medium text-indigo-600 dark:text-indigo-400 mb-1">Preferred Language</p>
                                    ...
                                    {clause.playbookMatch.minimumAcceptable && (
                                      <div>
                                        <p className="text-xs font-medium text-indigo-600 dark:text-indigo-400 mb-1">Minimum Acceptable</p>
                                        <p className="text-sm text-slate-700 dark:text-slate-300 bg-white/50 dark:bg-slate-700/50 rounded p-2">
                                          {clause.playbookMatch.minimumAcceptable}
                                        </p>
                                      </div>
