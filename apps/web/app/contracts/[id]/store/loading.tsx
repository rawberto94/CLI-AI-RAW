...
import { Database, Archive, FolderOpen, HardDrive } from 'lucide-react';
      ...
      <div className="flex flex-col items-center">
        ...
        <div className="relative">
          <motion.div
            ...
            className="w-20 h-20 rounded-2xl bg-gradient-to-br from-slate-500 via-gray-500 to-slate-600 shadow-2xl shadow-slate-500/30 flex items-center justify-center"
          >
        ...
        >
          ...
          <p className="text-sm text-muted-foreground mt-1">Accessing storage...</p>
