...
import { GitCompare, FileText, Edit, MessageSquare } from 'lucide-react';

export default function RedlineViewLoading() {
  return (
      ...
      <div className="flex flex-col items-center">
        ...
        <div className="relative">
          <motion.div
            ...
            className="w-20 h-20 rounded-2xl bg-gradient-to-br from-red-500 via-rose-500 to-red-600 shadow-2xl shadow-red-500/30 flex items-center justify-center"
          >
        ...
        >
          <h2 className="text-xl font-semibold bg-gradient-to-r from-red-600 to-rose-600 bg-clip-text text-transparent">
            Loading Redline View
          </h2>
          <p className="text-sm text-muted-foreground mt-1">Preparing contract comparison...</p>
