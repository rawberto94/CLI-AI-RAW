...
import { Sparkles, Eye, Star, Zap } from 'lucide-react';

export default function EnhancedViewLoading() {
  return (
      ...
      <div className="flex flex-col items-center">
        ...
        >
          <h2 className="text-xl font-semibold bg-gradient-to-r from-violet-600 to-purple-600 bg-clip-text text-transparent">
            Loading Enhanced View
          </h2>
          <p className="text-sm text-muted-foreground mt-1">Preparing enhanced analysis...</p>
