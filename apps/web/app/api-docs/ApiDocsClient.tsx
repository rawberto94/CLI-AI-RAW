...
// Mock API documentation data (client-side)
const apiData = {
  overview: {
    version: "2.4.1",
          ...
          <div className="space-y-4">
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-gray-600 text-sm">
                  Sign up for an account and generate your API token from the
                  dashboard
                </p>
              </div>
            </div>
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-gray-600 text-sm">
                  Use curl or your preferred HTTP client to test the API
                </p>
                <div className="mt-2 p-3 bg-gray-900 rounded-lg text-green-400 text-sm font-mono">
                  curl -H "Authorization: Bearer YOUR_TOKEN"{" "}
                  {apiData.overview.baseUrl}/contracts
                </div>
              </div>
            </div>
            <div className="flex items-start gap-4">
