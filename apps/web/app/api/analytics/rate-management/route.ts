    ...
    switch (action) {
      case "list":
        ...
        const filters = {
          ...
          deliveryModel:
            (searchParams.get("deliveryModel") as any) || undefined,
  ...
  try {
    ...
    switch (action) {
      case "create":
        ...
        result = await rateCardManagementService.createRateCard(
          rateCard,
          tenantId
        );
        break;
      ...
      case "update":
        ...
        result = await rateCardManagementService.updateRateCard(
          rateCardId,
          updates,
          tenantId
        );
      ...
      case "delete":
        ...
        result = await rateCardManagementService.deleteRateCard(
          deleteId,
          tenantId
        );
        break;
      ...
      case "bulk_upload":
        ...
        result = await rateCardManagementService.processBulkUpload(
          data,
          tenantId
        );
        break;
...
export async function PUT(request: NextRequest) {
  try {
    ...
    const result = await rateCardManagementService.updateRateCard(
      rateCardId,
      updates,
      tenantId
    );
...
export async function DELETE(request: NextRequest) {
  try {
    ...
    const result = await rateCardManagementService.deleteRateCard(
      rateCardId,
      tenantId
    );
