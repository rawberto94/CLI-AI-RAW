...
import { withAuthApiHandler, createSuccessResponse, createValidationErrorResponse } from '@/lib/api-middleware'
import { z } from 'zod'
...
export const POST = withAuthApiHandler(async (request: NextRequest, ctx) => {
  ...
  // Build where clause (tenant-scoped — prevents cross-tenant search IDOR)
