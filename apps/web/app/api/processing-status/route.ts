...
import { processingPipeline } from '../../../../api/services/processing-pipeline'
...
export async function GET(request: NextRequest) {
  try {
    ...
    const jobs = processingPipeline.getJobsByTenant(tenantId)
        ...
        return NextResponse.json(
          {
            ...
            validActions: ['pause_job', 'resume_job', 'cancel_job', 'retry_job', 'restart_worker']
          },
          { status: 400 }
        )
    }
