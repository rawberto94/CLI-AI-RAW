...
const CLUSTER_CONFIG = {
  guardians: {
    ...
    color: '#3b82f6',
    icon: '🛡️',
    agents: ['sentinel', 'vigil', 'warden', 'mediator', 'proactive-validation-agent', 'compliance-monitoring-agent', 'proactive-risk-detector', 'conflict-resolution-agent'],
  },
  oracles: {
    name: 'Oracles',
    color: '#8b5cf6',
    icon: '🔮',
    agents: ['sage', 'prospector', 'scout', 'memorykeeper', 'synthesizer', 'intelligent-search-agent', 'opportunity-discovery-engine', 'rfx-detection-agent', 'contract-transformation-agent', 'data-synthesizer-agent'],
  },
  operators: {
    name: 'Operators',
    color: '#10b981',
    icon: '⚙️',
    agents: ['clockwork', 'steward', 'artificer', 'builder', 'autonomous-deadline-manager', 'obligation-tracking-agent', 'smart-gap-filling-agent', 'template-generation-agent'],
  },
  strategists: {
    name: 'Strategists',
    color: '#f59e0b',
    icon: '🎯',
    agents: ['blueprinter', 'merchant', 'conductor', 'navigator', 'workflow-authoring-agent', 'rfx-procurement-agent', 'multi-agent-coordinator', 'onboarding-coach-agent'],
  },
  evolution: {
    name: 'Evolution',
    color: '#ec4899',
    icon: '🧬',
    agents: ['orchestrator', 'mnemosyne', 'swarm', 'ab', 'workflow-orchestrator-agent', 'user-feedback-learner', 'agent-swarm', 'ab-testing-engine'],
  },
};
...
const AGENT_METADATA: Record<string, { codename: string; cluster: string; avatar: string }> = {
  ...
  'obligation-tracking-agent': { codename: 'Steward', cluster: 'operators', avatar: '📋' },
  'smart-gap-filling-agent': { codename: 'Artificer', cluster: 'operators', avatar: '🔧' },
  'conflict-resolution-agent': { codename: 'Mediator', cluster: 'guardians', avatar: '⚖️' },
  'workflow-authoring-agent': { codename: 'Blueprinter', cluster: 'strategists', avatar: '📐' },
  ...
  'contract-transformation-agent': { codename: 'MemoryKeeper', cluster: 'oracles', avatar: '🧬' },
  'workflow-orchestrator-agent': { codename: 'Orchestrator', cluster: 'evolution', avatar: '🎼' },
  'template-generation-agent': { codename: 'Builder', cluster: 'operators', avatar: '🏗️' },
  'data-synthesizer-agent': { codename: 'Synthesizer', cluster: 'oracles', avatar: '🔮' },
  'multi-agent-coordinator': { codename: 'Conductor', cluster: 'strategists', avatar: '🎼' },
  'user-feedback-learner': { codename: 'Mnemosyne', cluster: 'evolution', avatar: '🧠' },
  'ab-testing-engine': { codename: 'A/B', cluster: 'evolution', avatar: '🧪' },
  'agent-swarm': { codename: 'Swarm', cluster: 'evolution', avatar: '🐝' },
};
