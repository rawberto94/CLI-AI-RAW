...
export const metadata: Metadata = {
  ...
  description:
    'ConTigo is a Zürich-based AI contract intelligence platform built by practitioners from procurement consulting, managed services, and data architecture.',
};
...
const milestones = [
  { year: '2023', title: 'Founded in Zürich', description: 'A team from procurement consulting and data architecture came together with a shared vision for intelligent contract management.' },
...
const stats = [
  ...
  { value: 'CH', label: 'Swiss Data Residency' },
        ...
        <div className="relative mx-auto max-w-[1600px] px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="mt-6 text-xl text-slate-400 max-w-3xl mx-auto">
              ConTigo was built by practitioners who lived the pain of contract management every day —
              combining procurement consulting, managed services, and data architecture expertise.
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-lg text-slate-400 leading-relaxed mb-6">
                As procurement consultants and managed services providers, our team spent years dealing with the same problem:
              ...
              <p className="text-lg text-slate-400 leading-relaxed mb-6">
                Combining that frontline experience with deep data architecture expertise, the vision became clear —
