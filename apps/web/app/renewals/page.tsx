...
export default function RenewalsPage() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-green-50/30 to-emerald-50/20 dark:from-slate-900 dark:via-green-950/30 dark:to-emerald-950/20">
