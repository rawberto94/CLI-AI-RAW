...
import { RefreshCw, Calendar, Clock, Bell } from 'lucide-react';
      ...
      >
        <div className="relative">
          <motion.div
            ...
            className="w-20 h-20 rounded-2xl bg-gradient-to-br from-amber-500 via-orange-500 to-red-500 flex items-center justify-center shadow-2xl shadow-amber-500/30"
          >
        ...
        >
          ...
          <p className="text-sm text-slate-500 mt-2">Checking renewal schedules...</p>
        </motion.div>
