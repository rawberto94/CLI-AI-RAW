      ...
      >
        <div className="relative">
          <motion.div
            ...
            className="w-20 h-20 rounded-2xl bg-gradient-to-br from-slate-500 via-slate-600 to-purple-500 flex items-center justify-center shadow-2xl shadow-slate-500/30"
          >
        ...
        <div className="flex items-center justify-center gap-2 mt-6">
          {[0, 1, 2].map((i) => (
            <motion.div
              ...
              className="w-2 h-2 rounded-full bg-gradient-to-r from-slate-500 to-purple-500"
            />
          ))}
        </div>
      </motion.div>
