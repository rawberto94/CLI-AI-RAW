...
export default function RateBaselinesLoading() {
  return (
      ...
      >
        <div className="relative">
          <motion.div
            ...
            className="w-20 h-20 rounded-2xl bg-gradient-to-br from-slate-500 via-slate-600 to-blue-500 flex items-center justify-center shadow-2xl shadow-slate-500/30"
          >
        ...
        >
          <h2 className="text-xl font-semibold bg-gradient-to-r from-slate-600 to-blue-600 bg-clip-text text-transparent">
            Loading Rate Baselines
          </h2>
          <p className="text-sm text-slate-500 mt-2">Fetching baseline data...</p>
        </motion.div>
        ...
        <div className="flex items-center justify-center gap-2 mt-6">
          {[0, 1, 2].map((i) => (
            <motion.div
              ...
              className="w-2 h-2 rounded-full bg-gradient-to-r from-slate-500 to-blue-500"
            />
          ))}
        </div>
      </motion.div>
