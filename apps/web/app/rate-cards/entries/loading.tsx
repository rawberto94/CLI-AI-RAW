...
import { List, FileText, Database, Filter } from 'lucide-react';

export default function RateCardEntriesLoading() {
  return (
      ...
      >
        <div className="relative">
          <motion.div
            ...
            className="w-20 h-20 rounded-2xl bg-gradient-to-br from-violet-500 via-purple-600 to-purple-500 flex items-center justify-center shadow-2xl shadow-violet-500/30"
          >
        ...
        >
          <h2 className="text-xl font-semibold bg-gradient-to-r from-violet-600 to-purple-600 bg-clip-text text-transparent">
            Loading Rate Card Entries
          </h2>
          <p className="text-sm text-slate-500 mt-2">Fetching entry data...</p>
        </motion.div>
