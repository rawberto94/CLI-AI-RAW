      ...
      >
        <div className="relative">
          <motion.div
            ...
            className="w-20 h-20 rounded-2xl bg-gradient-to-br from-teal-500 via-teal-600 to-cyan-500 flex items-center justify-center shadow-2xl shadow-teal-500/30"
          >
