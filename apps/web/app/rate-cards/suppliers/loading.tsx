      ...
      >
        <div className="relative">
          <motion.div
            ...
            className="w-20 h-20 rounded-2xl bg-gradient-to-br from-cyan-500 via-cyan-600 to-teal-500 flex items-center justify-center shadow-2xl shadow-cyan-500/30"
          >
