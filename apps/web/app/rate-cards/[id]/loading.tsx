...
import { FileText, DollarSign, Eye, BarChart3 } from 'lucide-react';

export default function RateCardDetailsLoading() {
  return (
      ...
      >
        <div className="relative">
          <motion.div
            ...
            className="w-20 h-20 rounded-2xl bg-gradient-to-br from-green-500 via-green-600 to-emerald-500 flex items-center justify-center shadow-2xl shadow-green-500/30"
          >
        ...
        >
          <h2 className="text-xl font-semibold bg-gradient-to-r from-green-600 to-emerald-600 bg-clip-text text-transparent">
            Loading Rate Card Details
          </h2>
          <p className="text-sm text-slate-500 mt-2">Fetching rate card data...</p>
        </motion.div>
