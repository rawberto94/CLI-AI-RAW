...
import { ArrowLeftRight, TrendingUp, BarChart3, Target } from 'lucide-react';

export default function BaselineComparisonLoading() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-slate-100 dark:from-slate-900 dark:via-slate-900 dark:to-slate-800 flex items-center justify-center">
      ...
      >
        ...
        >
          ...
          <p className="text-sm text-slate-500 mt-2">Analyzing comparison data...</p>
        </motion.div>
