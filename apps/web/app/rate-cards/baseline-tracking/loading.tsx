...
import { Activity, TrendingUp, LineChart, Target } from 'lucide-react';

export default function BaselineTrackingLoading() {
  return (
      ...
      >
        ...
        >
          <h2 className="text-xl font-semibold bg-gradient-to-r from-indigo-600 to-purple-600 bg-clip-text text-transparent">
            Loading Baseline Tracking
          </h2>
          <p className="text-sm text-slate-500 mt-2">Fetching tracking data...</p>
        </motion.div>
