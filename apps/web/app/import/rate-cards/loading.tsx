...
import { Upload, DollarSign, FileSpreadsheet, CheckCircle } from 'lucide-react';

const orbitingIcons = [
  { Icon: FileSpreadsheet, delay: 0 },
  { Icon: DollarSign, delay: 1 },
  { Icon: CheckCircle, delay: 2 },
];

export default function RateCardImportLoading() {
  return (
            ...
            {orbitingIcons.map(({ Icon, delay }, index) => {
              ...
              return (
                <motion.div
                  ...
                  className="absolute w-8 h-8 rounded-full bg-white shadow-lg flex items-center justify-center border border-emerald-100"
                  style={{
