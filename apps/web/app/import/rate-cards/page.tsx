      ...
      <div className="max-w-5xl mx-auto px-4">
          ...
          <div className="bg-green-50 border border-green-200 rounded-lg p-4 mb-6">
            ...
            <div className="space-y-1">
              {uploadedJobs.map((jobId, index) => (
                <div key={jobId} className="text-sm text-green-600">
                  Job {index + 1}: {jobId}
                </div>
              ))}
            </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          <div className="bg-white rounded-lg shadow p-6">
            ...
            <h3 className="font-medium text-gray-900 mb-1">Excel Files</h3>
          ...
          <div className="bg-white rounded-lg shadow p-6">
            <div className="text-3xl mb-2">📄</div>
            <h3 className="font-medium text-gray-900 mb-1">CSV Files</h3>
            <p className="text-sm text-gray-600">
          ...
          <div className="bg-white rounded-lg shadow p-6">
            <div className="text-3xl mb-2">📕</div>
            <h3 className="font-medium text-gray-900 mb-1">PDF Files</h3>
            <p className="text-sm text-gray-600">
        ...
        <div className="bg-white rounded-lg shadow p-6">
          ...
          <ol className="space-y-3 text-gray-600">
            <li className="flex gap-3">
              ...
              <span>
                <strong>Upload Files:</strong> Drag and drop or select rate card files
              </span>
            </li>
            <li className="flex gap-3">
              <span className="flex-shrink-0 w-6 h-6 bg-blue-100 text-blue-600 rounded-full flex items-center justify-center text-sm font-medium">
              ...
              <span>
                <strong>Automatic Processing:</strong> Our system extracts and validates the data
              </span>
            </li>
            <li className="flex gap-3">
              <span className="flex-shrink-0 w-6 h-6 bg-blue-100 text-blue-600 rounded-full flex items-center justify-center text-sm font-medium">
              ...
              <span>
                <strong>Review & Approve:</strong> Check the mapped data and approve for import
              </span>
            </li>
            <li className="flex gap-3">
              <span className="flex-shrink-0 w-6 h-6 bg-blue-100 text-blue-600 rounded-full flex items-center justify-center text-sm font-medium">
              ...
              <span>
                <strong>Ready to Use:</strong> Normalized rates are available for benchmarking
              </span>
            </li>
          </ol>
        </div>
