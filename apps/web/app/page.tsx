    ...
    <>
      ...
      <Grid cols={4} gap="md">
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">{dashboardData.overview.totalContracts.toLocaleString()}</div>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">{formatCurrency(dashboardData.overview.totalValue)}</div>
            <p className="text-xs text-muted-foreground">
              +12% from last month
            </p>
          </CardContent>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold text-green-600">{dashboardData.overview.riskScore}</div>
            <p className="text-xs text-muted-foreground">
              Low risk portfolio
            </p>
          </CardContent>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold text-green-600">{formatPercentage(dashboardData.overview.complianceScore)}</div>
            ...
            <CardContent>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div className="text-center p-4 bg-white/50 rounded-lg">
                  ...
                  <p className="text-sm text-muted-foreground">Instant contract analysis</p>
                </div>
                <div className="text-center p-4 bg-white/50 rounded-lg">
                ...
                <div className="text-center p-4 bg-white/50 rounded-lg">
                  ...
                  <p className="text-sm text-muted-foreground">Procurement optimization</p>
                </div>
              </div>
            </CardContent>
          </Card>
              ...
              <Grid cols={4} gap="sm">
                {dashboardData.quickStats.map((stat, index) => (
                  <div key={index} className="text-center p-4 bg-muted/50 rounded-lg">
                    <stat.icon className={`h-6 w-6 mx-auto mb-2 text-${stat.color}-600`} />
            ...
            <CardContent className="space-y-3">
              <Button variant="outline" size="sm" className="w-full justify-start" asChild>
                <Link href="/integration-demo">
                  ...
                  Integration Demo
                  <Badge variant="secondary" className="ml-auto bg-blue-100 text-blue-800">Live</Badge>
                </Link>
              </Button>
