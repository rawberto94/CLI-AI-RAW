      ...
      >
        <div className="relative">
          <motion.div
            ...
            className="w-20 h-20 rounded-2xl bg-gradient-to-br from-pink-500 via-rose-500 to-red-500 flex items-center justify-center shadow-2xl shadow-pink-500/30"
          >
        ...
        >
          ...
          <p className="text-sm text-slate-500 mt-2">Preparing AI generation tools...</p>
        </motion.div>
