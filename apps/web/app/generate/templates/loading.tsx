...
import { FileStack, Copy, Layout, Sparkles } from 'lucide-react';
      ...
      >
        ...
        <div className="relative">
          ...
          <motion.div
            ...
            className="w-20 h-20 rounded-2xl bg-gradient-to-br from-purple-500 to-purple-500 flex items-center justify-center shadow-2xl"
          >
            ...
            {orbitingIcons.map(({ Icon, delay }, index) => {
              ...
              return (
                <motion.div
                  ...
                  className="absolute w-8 h-8 rounded-lg bg-white shadow-lg flex items-center justify-center border border-indigo-100"
                  style={{
                    left: '50%',
                    top: '50%',
