...
import { LogIn, Shield, Key, User } from 'lucide-react';
      ...
      <div className="flex flex-col items-center">
        ...
        <div className="relative">
          <motion.div
            ...
            className="w-20 h-20 rounded-2xl bg-gradient-to-br from-blue-500 via-indigo-500 to-purple-500 shadow-2xl shadow-blue-500/30 flex items-center justify-center"
          >
        ...
        >
          ...
          <p className="text-sm text-muted-foreground mt-1">Preparing secure authentication...</p>
