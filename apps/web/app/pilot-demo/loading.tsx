...
import { Rocket, Sparkles, Play, Star } from 'lucide-react';

export default function PilotDemoLoading() {
  return (
      ...
      <div className="flex flex-col items-center">
        ...
        <div className="relative">
          <motion.div
            ...
            className="w-20 h-20 rounded-2xl bg-gradient-to-br from-orange-500 via-red-500 to-rose-500 shadow-2xl shadow-orange-500/30 flex items-center justify-center"
          >
        ...
        >
          ...
          <p className="text-sm text-muted-foreground mt-1">Preparing demo environment...</p>
