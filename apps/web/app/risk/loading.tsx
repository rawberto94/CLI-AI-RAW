...
import { AlertTriangle, Shield, ShieldAlert, Eye } from 'lucide-react';
      ...
      >
        <div className="relative">
          <motion.div
            ...
            className="w-20 h-20 rounded-2xl bg-gradient-to-br from-red-500 via-rose-500 to-pink-500 flex items-center justify-center shadow-2xl shadow-red-500/30"
          >
        ...
        >
          ...
          <p className="text-sm text-slate-500 mt-2">Analyzing risk factors...</p>
        </motion.div>
