...
import { Cog, Clock, CheckCircle, RotateCw } from 'lucide-react';
      ...
      <div className="flex flex-col items-center">
        ...
        <div className="relative">
          <motion.div
            ...
            className="w-20 h-20 rounded-2xl bg-gradient-to-br from-slate-500 via-gray-500 to-zinc-600 shadow-2xl shadow-slate-500/30 flex items-center justify-center"
          >
          ...
          >
            ...
            <div className="absolute -bottom-3 left-1/2 -translate-x-1/2 p-1.5 bg-white rounded-full shadow-lg">
              <RotateCw className="h-4 w-4 text-zinc-600" />
            </div>
          </motion.div>
        </div>
        ...
        >
          ...
          <p className="text-sm text-muted-foreground mt-1">Checking job statuses...</p>
          ...
          <div className="flex justify-center gap-1 mt-4">
            {[0, 1, 2].map((i) => (
              <motion.div
                ...
                className="w-2 h-2 rounded-full bg-gradient-to-r from-slate-500 to-gray-500"
              />
            ))}
          </div>
        </motion.div>
