      ...
      >
        ...
        <div className="relative mb-8">
          <motion.div
            ...
            className="w-20 h-20 mx-auto rounded-2xl bg-gradient-to-br from-violet-500 via-purple-500 to-purple-500 flex items-center justify-center shadow-2xl shadow-purple-500/30"
          >
