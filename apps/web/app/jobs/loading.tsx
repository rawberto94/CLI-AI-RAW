...
import { ListTodo, Clock, CheckCircle, Loader } from 'lucide-react';
      ...
      <div className="flex flex-col items-center">
        ...
        <div className="relative">
          <motion.div
            ...
            className="w-20 h-20 rounded-2xl bg-gradient-to-br from-teal-500 via-cyan-500 to-blue-500 shadow-2xl shadow-teal-500/30 flex items-center justify-center"
          >
        ...
        >
          ...
          <p className="text-sm text-muted-foreground mt-1">Fetching job queue...</p>
