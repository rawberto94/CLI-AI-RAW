      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600 mt-1">
            Find contracts quickly with AI-powered semantic search
          </p>
        </div>
                  ...
                  <div className="flex items-start justify-between mb-4">
                    ...
                    <div className="ml-6 text-right">
                      ...
                      <div className="space-y-2 mb-4">
                        <div
                          className={`inline-flex items-center gap-1 px-2 py-1 rounded text-xs font-medium ${getRiskColor(
                            contract.riskScore
                          )}`}
                        >
        ...
        <Card>
          <CardContent className="p-12 text-center">
            ...
            <div className="flex justify-center gap-3">
              ...
              <Link href="/search/advanced">
                <Button>Try Advanced Search</Button>
              </Link>
            </div>
          </CardContent>
        </Card>
