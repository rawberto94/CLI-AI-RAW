...
import { Search, Filter, Sliders, SlidersHorizontal, type LucideIcon } from 'lucide-react';
...
export default function AdvancedSearchLoading() {
  const orbitingIcons: OrbitingIconProps[] = [
    { icon: Filter, delay: 0, radius: 80, colorClass: 'bg-purple-500/90' },
    { icon: Sliders, delay: 2.67, radius: 80, colorClass: 'bg-violet-500/90' },
    { icon: SlidersHorizontal, delay: 5.33, radius: 80, colorClass: 'bg-purple-600/90' },
  ];
      ...
      >
        <div className="relative w-48 h-48 flex items-center justify-center">
          ...
          <motion.div
            ...
            className="w-20 h-20 rounded-2xl bg-gradient-to-br from-purple-500 to-violet-600 flex items-center justify-center shadow-2xl"
          >
