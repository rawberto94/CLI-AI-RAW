...
export const metadata: Metadata = {
  ...
  description: 'Advanced contract search with detailed filters and complex criteria',
}
...
export default function AdvancedSearchPage() {
  ...
  const addCustomField = () => {
    setSearchCriteria(prev => ({
      ...prev,
      customFields: [...prev.customFields, { field: '', operator: '', value: '' }]
    }))
  }
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <h1 className="text-3xl font-bold text-gray-900">Advanced Contract Search</h1>
          <p className="text-gray-600 mt-1">Use detailed filters to find exactly what you're looking for</p>
        </div>
        ...
        <div className="lg:col-span-2 space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) => setSearchCriteria(prev => ({ ...prev, contractType: e.target.value }))}
                    className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                  >
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) => setSearchCriteria(prev => ({ ...prev, client: e.target.value }))}
                    className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                  >
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) => setSearchCriteria(prev => ({ ...prev, supplier: e.target.value }))}
                    className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                  >
              ...
              <div>
                ...
                <div className="grid grid-cols-2 gap-4">
                  <input
                    ...
                    onChange={(e) => setSearchCriteria(prev => ({ ...prev, valueMin: e.target.value }))}
                  ...
                  <input
                    ...
                    onChange={(e) => setSearchCriteria(prev => ({ ...prev, valueMax: e.target.value }))}
                    className="px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                  />
                </div>
              </div>
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-2">Expiry Date Range</label>
                <div className="grid grid-cols-2 gap-4">
                  <input
                    type="date"
                    value={searchCriteria.expiryFrom}
                    onChange={(e) => setSearchCriteria(prev => ({ ...prev, expiryFrom: e.target.value }))}
                    className="px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                  />
                  <input
                    type="date"
                    value={searchCriteria.expiryTo}
                    onChange={(e) => setSearchCriteria(prev => ({ ...prev, expiryTo: e.target.value }))}
                    className="px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                  />
                </div>
              </div>
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <div>
                ...
                <div className="grid grid-cols-2 gap-4">
                  <input
                    ...
                    onChange={(e) => setSearchCriteria(prev => ({ ...prev, riskScoreMin: e.target.value }))}
                    className="px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                  />
                  <input
                    type="number"
                    ...
                    onChange={(e) => setSearchCriteria(prev => ({ ...prev, riskScoreMax: e.target.value }))}
                    className="px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                  />
                </div>
              </div>
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-2">Minimum Compliance Score</label>
                <input
                  type="number"
                  ...
                  onChange={(e) => setSearchCriteria(prev => ({ ...prev, complianceMin: e.target.value }))}
                  className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                />
              </div>
            </CardContent>
                  ...
                  <div className="col-span-4">
                    <input
                      ...
                      onChange={(e) => {
                        ...
                        setSearchCriteria(prev => ({ ...prev, customFields: newFields }))
                      }}
                      className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                    />
                  </div>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-center py-12">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-2">Advanced search executed</h3>
              <p className="text-gray-600 mb-6">
                Your search criteria have been processed. In a real implementation, results would appear here.
              </p>
              <Link href="/search">
                <Button>
                  View Sample Results
