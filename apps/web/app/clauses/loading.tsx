      ...
      >
        <div className="relative">
          <motion.div
            ...
            className="w-20 h-20 rounded-2xl bg-gradient-to-br from-indigo-500 via-blue-500 to-cyan-500 flex items-center justify-center shadow-2xl shadow-indigo-500/30"
          >
        ...
        >
          ...
          <p className="text-sm text-slate-500 mt-2">Fetching clauses...</p>
        </motion.div>
        ...
        <div className="flex items-center justify-center gap-2 mt-6">
          {[0, 1, 2].map((i) => (
            <motion.div
              ...
              className="w-2 h-2 rounded-full bg-gradient-to-r from-indigo-500 to-blue-500"
            />
          ))}
        </div>
      </motion.div>
