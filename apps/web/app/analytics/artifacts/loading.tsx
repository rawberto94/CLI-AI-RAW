...
export default function ArtifactAnalyticsLoading() {
  return (
      ...
      <div className="flex flex-col items-center">
        <div className="relative">
          <motion.div
            ...
            className="w-20 h-20 rounded-2xl bg-gradient-to-br from-violet-500 via-purple-600 to-purple-500 shadow-2xl shadow-violet-500/30 flex items-center justify-center"
          >
        ...
        >
          <h2 className="text-xl font-semibold bg-gradient-to-r from-violet-600 to-purple-600 bg-clip-text text-transparent">
            Loading Artifact Analytics
          </h2>
          <p className="text-sm text-muted-foreground mt-1">Analyzing your documents and insights...</p>
