...
import { Building2, Users, Globe, BarChart3 } from 'lucide-react';

export default function SupplierAnalyticsLoading() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-slate-100 dark:from-slate-900 dark:via-slate-900 dark:to-slate-800 flex items-center justify-center">
      <div className="flex flex-col items-center">
        ...
        >
          ...
          <p className="text-sm text-muted-foreground mt-1">Fetching supplier data and performance metrics...</p>
