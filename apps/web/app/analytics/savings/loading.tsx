...
export default function SavingsAnalyticsLoading() {
  return (
      ...
      <div className="flex flex-col items-center">
        <div className="relative">
          <motion.div
            ...
            className="w-20 h-20 rounded-2xl bg-gradient-to-br from-emerald-500 via-emerald-600 to-teal-500 shadow-2xl shadow-emerald-500/30 flex items-center justify-center"
          >
        ...
        >
          ...
          <p className="text-sm text-muted-foreground mt-1">Calculating your cost savings and opportunities...</p>
