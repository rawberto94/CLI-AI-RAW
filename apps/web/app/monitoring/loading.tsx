      ...
      >
        <div className="relative">
          <motion.div
            ...
            className="w-20 h-20 rounded-2xl bg-gradient-to-br from-green-500 via-emerald-500 to-cyan-500 flex items-center justify-center shadow-2xl shadow-green-500/30"
          >
