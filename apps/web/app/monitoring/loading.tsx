      ...
      >
        <div className="relative">
          <motion.div
            ...
            className="w-20 h-20 rounded-2xl bg-gradient-to-br from-violet-500 via-violet-500 to-purple-500 flex items-center justify-center shadow-2xl shadow-green-500/30"
          >
        ...
        >
          ...
          <p className="text-sm text-slate-500 mt-2">Fetching system status...</p>
        </motion.div>
