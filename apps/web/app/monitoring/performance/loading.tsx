...
import { Activity, Server, Gauge, TrendingUp } from 'lucide-react';
...
function OrbitingIcon({ icon: Icon, delay, radius }: OrbitingIconProps) {
  return (
    ...
    >
      <div
        className="absolute w-10 h-10 rounded-xl bg-white shadow-lg border border-green-100 flex items-center justify-center"
...
export default function PerformanceMonitoringLoading() {
  const orbitingIcons: Array<{ icon: LucideIcon; delay: number }> = [
    { icon: Server, delay: 0 },
    { icon: Gauge, delay: 2.67 },
    { icon: TrendingUp, delay: 5.33 },
  ];
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-slate-100 dark:from-slate-900 dark:via-slate-900 dark:to-slate-800 flex flex-col items-center justify-center p-8">
      ...
      >
        ...
        <div className="relative w-48 h-48">
          {/* Orbit path */}
          <div className="absolute inset-4 rounded-full border-2 border-dashed border-green-200 opacity-50" />
