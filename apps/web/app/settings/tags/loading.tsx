...
import { Tag, Hash, Bookmark, Tags } from 'lucide-react';

export default function TagSettingsLoading() {
  return (
      ...
      >
        <div className="relative">
          <motion.div
            ...
            className="w-20 h-20 rounded-2xl bg-gradient-to-br from-violet-500 via-green-500 to-violet-500 flex items-center justify-center shadow-2xl shadow-violet-500/30"
          >
        ...
        >
          ...
          <p className="text-sm text-slate-500 mt-2">Fetching your tags...</p>
        </motion.div>
