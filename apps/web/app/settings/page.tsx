...
export const metadata: Metadata = {
  ...
  description: 'Configure system parameters, user preferences, and integration settings',
}
        ...
        <div className="lg:col-span-3 space-y-6">
              ...
              <Card>
                ...
                <CardContent className="space-y-4">
                  ...
                  <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                    ...
                    <span className="text-sm font-medium text-gray-900">{settingsData.user.lastLogin}</span>
                  </div>
                </CardContent>
              </Card>
              ...
              <Card>
                ...
                <CardContent className="space-y-4">
                  ...
                  <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                    ...
                    <span className="text-sm font-medium text-gray-900">{settingsData.security.lastPasswordChange}</span>
                  </div>
              ...
              <Card>
                ...
                <CardContent className="space-y-4">
                  <div className="flex items-center justify-between p-4 bg-blue-50 rounded-lg border border-blue-200">
                    <div>
                      <h4 className="font-medium text-blue-800">Active API Tokens</h4>
                      <p className="text-sm text-blue-600">{settingsData.security.apiTokens} tokens currently active</p>
                    </div>
                    <Button variant="outline" size="sm">
                      Manage Tokens
                    </Button>
                  ...
                  <div>
                    <label className="block text-sm font-medium text-gray-700 mb-2">Primary API Key</label>
              ...
              <CardContent className="space-y-6">
                <div>
                  ...
                  <div className="space-y-3">
                    {Object.entries(settingsData.notifications.email).map(([key, value]) => (
                ...
                <div>
                  ...
                  <div className="space-y-3">
                    {Object.entries(settingsData.notifications.push).map(([key, value]) => (
                      <div key={key} className="flex items-center justify-between">
                        <span className="text-sm text-gray-700 capitalize">
                          {key.replace(/([A-Z])/g, ' $1').trim()}
                        </span>
            ...
            <Card>
              ...
              <CardContent className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    <h4 className="font-medium text-gray-900 mb-4">Automated Processing</h4>
                    <div className="space-y-3">
                      <div className="flex items-center justify-between">
                        <span className="text-sm text-gray-700">Auto-process uploads</span>
                        <label className="relative inline-flex items-center cursor-pointer">
                          <input type="checkbox" defaultChecked={settingsData.processing.autoProcessing} className="sr-only peer" />
                          <div className="w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-blue-300 rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-blue-600"></div>
                        </label>
                      </div>
                      <div className="flex items-center justify-between">
                        ...
                        <label className="relative inline-flex items-center cursor-pointer">
                          <input type="checkbox" defaultChecked={settingsData.processing.aiAnalysis} className="sr-only peer" />
                          <div className="w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-blue-300 rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-blue-600"></div>
                        </label>
                      </div>
                      <div className="flex items-center justify-between">
                        ...
                        <label className="relative inline-flex items-center cursor-pointer">
                          <input type="checkbox" defaultChecked={settingsData.processing.riskAssessment} className="sr-only peer" />
                          <div className="w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-blue-300 rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-blue-600"></div>
                        </label>
                      </div>
                    </div>
          ...
          {activeTab === 'integrations' && (
            <Card>
              ...
              <CardContent>
                <div className="space-y-4">
                  {Object.entries(settingsData.integrations).map(([key, integration]) => (
                    <div key={key} className="flex items-center justify-between p-4 border border-gray-200 rounded-lg">
                      <div className="flex items-center gap-3">
                        <div className={`w-10 h-10 rounded-lg flex items-center justify-center ${
                          integration.enabled ? 'bg-green-100' : 'bg-gray-100'
                        }`}>
                          {key === 'sharepoint' && <FileText className="w-5 h-5 text-blue-600" />}
                          {key === 'salesforce' && <BarChart3 className="w-5 h-5 text-blue-600" />}
                          {key === 'slack' && <Bell className="w-5 h-5 text-purple-600" />}
                          {key === 'teams' && <Users className="w-5 h-5 text-blue-600" />}
                          {key === 'webhook' && <Globe className="w-5 h-5 text-green-600" />}
                        </div>
                        <div>
