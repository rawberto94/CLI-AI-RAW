...
import { Palette, Sparkles, Layout, Star, type LucideIcon } from 'lucide-react';
...
export default function UXDemoLoading() {
  const orbitingIcons: OrbitingIconProps[] = [
    { icon: Sparkles, delay: 0, radius: 80, colorClass: 'bg-pink-500/90' },
    { icon: Layout, delay: 2.67, radius: 80, colorClass: 'bg-rose-500/90' },
    { icon: Star, delay: 5.33, radius: 80, colorClass: 'bg-pink-600/90' },
  ];
      ...
      >
        <div className="relative w-48 h-48 flex items-center justify-center">
          ...
          <motion.div
            ...
            className="w-20 h-20 rounded-2xl bg-gradient-to-br from-pink-500 to-rose-600 flex items-center justify-center shadow-2xl"
          >
