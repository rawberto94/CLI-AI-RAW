...
import { FileStack, Eye, Edit, Copy, type LucideIcon } from 'lucide-react';
...
export default function TemplateDetailsLoading() {
  const orbitingIcons: OrbitingIconProps[] = [
    { icon: Eye, delay: 0, radius: 80, colorClass: 'bg-violet-500/90' },
    { icon: Edit, delay: 2.67, radius: 80, colorClass: 'bg-violet-500/90' },
    { icon: Copy, delay: 5.33, radius: 80, colorClass: 'bg-violet-600/90' },
  ];
