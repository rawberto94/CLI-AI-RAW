...
import { Search, Brain, Sparkles, Filter } from 'lucide-react';
        ...
        <div className="relative w-48 h-48">
          ...
          <div className="absolute inset-0 flex items-center justify-center">
            <motion.div
              ...
              className="w-20 h-20 rounded-2xl bg-gradient-to-br from-purple-500 to-violet-600 shadow-2xl flex items-center justify-center"
            >
