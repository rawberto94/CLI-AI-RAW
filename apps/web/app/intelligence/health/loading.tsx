...
import { Activity, Heart, Shield, CheckCircle } from 'lucide-react';
            ...
            {orbitingIcons.map(({ Icon, delay }, index) => {
              ...
              return (
                <motion.div
                  ...
                  className="absolute w-8 h-8 rounded-full bg-white shadow-lg flex items-center justify-center border border-green-100"
                  style={{
