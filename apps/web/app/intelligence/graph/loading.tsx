...
import { Share2, GitMerge, Network, Sparkles } from 'lucide-react';

const orbitingIcons = [
  { Icon: GitMerge, delay: 0 },
  { Icon: Network, delay: 1 },
  { Icon: Sparkles, delay: 2 },
];

export default function ContractGraphLoading() {
  return (
            ...
            {orbitingIcons.map(({ Icon, delay }, index) => {
              ...
              return (
                <motion.div
                  ...
                  className="absolute w-8 h-8 rounded-full bg-white shadow-lg flex items-center justify-center border border-blue-100"
                  style={{
