...
import { GitCompare, Scale, MessageSquare, FileText } from 'lucide-react';
...
function OrbitingIcon({ icon: Icon, delay, radius }: OrbitingIconProps) {
  return (
    ...
    >
      <div
        className="absolute w-10 h-10 rounded-xl bg-white shadow-lg border border-amber-100 flex items-center justify-center"
...
export default function NegotiateLoading() {
  const orbitingIcons: Array<{ icon: LucideIcon; delay: number }> = [
    { icon: Scale, delay: 0 },
    { icon: MessageSquare, delay: 2.67 },
    { icon: FileText, delay: 5.33 },
  ];
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-slate-100 dark:from-slate-900 dark:via-slate-900 dark:to-slate-800 flex flex-col items-center justify-center p-8">
      ...
      >
        ...
        <div className="relative w-48 h-48">
          {/* Orbit path */}
          <div className="absolute inset-4 rounded-full border-2 border-dashed border-amber-200 opacity-50" />
          ...
          <div className="absolute inset-0 flex items-center justify-center">
            <motion.div
              ...
              className="w-20 h-20 rounded-2xl bg-gradient-to-br from-amber-500 to-orange-600 shadow-2xl flex items-center justify-center"
            >
