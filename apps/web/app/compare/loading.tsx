...
import { GitCompare, ArrowLeftRight, FileText, Diff as _Diff } from 'lucide-react';
      ...
      >
        <div className="relative">
          <motion.div
            ...
            className="w-20 h-20 rounded-2xl bg-gradient-to-br from-purple-500 via-purple-500 to-violet-500 flex items-center justify-center shadow-2xl shadow-purple-500/30"
          >
        ...
        >
          ...
          <p className="text-sm text-slate-500 mt-2">Preparing comparison view...</p>
        </motion.div>
