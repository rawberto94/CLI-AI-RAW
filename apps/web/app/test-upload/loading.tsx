...
import { Upload, FileText, CheckCircle, AlertCircle, type LucideIcon } from 'lucide-react';
...
export default function TestUploadLoading() {
  const orbitingIcons: OrbitingIconProps[] = [
    { icon: FileText, delay: 0, radius: 80, colorClass: 'bg-gray-500/90' },
    { icon: CheckCircle, delay: 2.67, radius: 80, colorClass: 'bg-slate-500/90' },
    { icon: AlertCircle, delay: 5.33, radius: 80, colorClass: 'bg-gray-600/90' },
  ];
      ...
      >
        <div className="relative w-48 h-48 flex items-center justify-center">
          ...
          <motion.div
            ...
            className="w-20 h-20 rounded-2xl bg-gradient-to-br from-gray-500 to-slate-600 flex items-center justify-center shadow-2xl"
          >
