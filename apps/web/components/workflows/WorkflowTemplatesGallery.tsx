    ...
    <div className={cn('space-y-6', className)}>
      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        ...
        <div className="flex items-center gap-2">
          <Badge variant="outline" className="gap-1 bg-violet-50 text-violet-700 border-indigo-200">
      ...
      {filteredTemplates.length > 0 ? (
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {filteredTemplates.map((template, index) => (
            ...
            >
              <Card className="group hover:shadow-2xl transition-all duration-300 cursor-pointer h-full flex flex-col hover:scale-[1.02] focus-within:ring-2 focus-within:ring-violet-500 focus-within:ring-offset-2 dark:bg-slate-800 dark:border-slate-700 dark:hover:shadow-slate-900/50">
                <CardHeader>
                  <div className="flex items-start justify-between mb-3">
                    ...
                    <div className="flex flex-col gap-1">
                      ...
                      {template.recommended && (
                        <Badge className="bg-violet-500 text-white border-violet-600 text-xs">
                  ...
                  <CardTitle className="text-lg group-hover:text-violet-600 dark:group-hover:text-indigo-400 transition-colors dark:text-slate-100">
                    {template.name}
                  </CardTitle>
