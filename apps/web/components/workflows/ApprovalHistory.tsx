...
const typeConfig = {
  ...
  amendment: { label: 'Amendment', color: 'bg-violet-100 text-violet-700' },
      ...
      >
        ...
        {entry.metadata?.supplier && (
          <button
            ...
            className="mt-2 text-xs text-violet-600 hover:text-indigo-800 flex items-center gap-1 focus:outline-none focus:ring-2 focus:ring-violet-500/50 rounded px-1"
          >
          ...
          <div className="flex items-center gap-4 mb-6" role="search" aria-label="Filter approval history">
            <div className="relative flex-1 max-w-xs">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-2 border border-slate-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-violet-500/30 focus:border-indigo-300"
              />
            </div>
            ...
            <select
              ...
              className="px-3 py-2 border border-slate-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-violet-500/30 focus:border-indigo-300"
            >
        ...
        <div className="text-center py-12" role="status" aria-live="polite">
          ...
          {(searchQuery || filter !== 'all') && (
            <button
              ...
              className="text-sm text-violet-600 hover:text-indigo-800 font-medium focus:outline-none focus:ring-2 focus:ring-violet-500/50 rounded px-2 py-1"
            >
              Clear all filters
            </button>
          )}
    ...
    <div className={cn('space-y-2', className)}>
      ...
      {history.length >= limit && (
        <Link
          ...
          className="block text-center text-sm text-violet-600 hover:text-indigo-800 py-2 font-medium"
        >
          View all history →
        </Link>
      )}
