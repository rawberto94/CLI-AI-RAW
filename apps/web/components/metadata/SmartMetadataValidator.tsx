...
export function SmartMetadataValidator({
  ...
  const getStatusColor = (status: string) => {
    switch (status) {
      case 'validated': return 'text-emerald-600 bg-emerald-50 border-emerald-200';
    ...
    <div className={cn("space-y-6", className)}>
      ...
      <div className="grid grid-cols-2 md:grid-cols-5 gap-3">
        ...
        <Card className="border-emerald-200 bg-emerald-50/50">
          <CardContent className="p-4 text-center">
            <p className="text-2xl font-bold text-emerald-600">{summary.validated}</p>
      ...
      <Card className="border-blue-200 bg-blue-50/50">
        <CardContent className="p-4">
          <div className="flex items-start gap-3">
            ...
            <div>
              <p className="font-medium text-blue-900 mb-1">Validation Tips</p>
