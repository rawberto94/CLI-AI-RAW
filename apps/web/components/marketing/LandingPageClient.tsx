...
// Floating Particle Background — uses seeded positions to avoid hydration mismatch
function ParticleField() {
  // Deterministic pseudo-random based on index (same on server + client)
  const particles = Array.from({ length: 20 }, (_, i) => ({
    left: ((i * 37 + 13) % 100),
    top: ((i * 53 + 7) % 100),
    duration: 5 + ((i * 41 + 3) % 10),
    delay: ((i * 29 + 11) % 5),
  }));
    ...
    <div className="border-b border-gray-200 last:border-b-0">
      ...
      >
        ...
        <div className={`w-8 h-8 rounded-full bg-gray-100 group-hover:bg-violet-100 flex items-center justify-center transition-all duration-300 ${isOpen ? 'bg-violet-100 rotate-180' : ''}`}>
          <ChevronDown aria-hidden="true" className={`w-5 h-5 text-gray-500 group-hover:text-violet-600 transition-all duration-300 ${isOpen ? 'text-violet-600' : ''}`} />
        </div>
      </button>
      <div id={`faq-panel-${index}`} role="region" aria-labelledby={`faq-button-${index}`} className={`grid transition-all duration-300 ${isOpen ? 'grid-rows-[1fr] pb-6' : 'grid-rows-[0fr]'}`}>
          ...
          <div className="relative">
            <div className="flex items-start justify-between mb-6">
              ...
              <div className="text-right">
                <div className="text-3xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-violet-600 to-purple-600 group-hover:from-violet-500 group-hover:to-violet-500 transition-all">{stat}</div>
...
export default function LandingPageClient() {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: "Absolutely. We use AES-256 encryption for all data at rest and in transit. Our platform is designed with a compliance-ready architecture. We maintain comprehensive, tamper-proof audit logs. Your data never leaves our secure infrastructure."
    },
    {
    ...
    <div className="min-h-screen bg-white">
          ...
          <div className="max-w-5xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-16">
              ...
              <a href="#ai-technology" className="group relative text-gray-700 px-8 py-4 rounded-full font-semibold border-2 border-gray-200 hover:border-violet-400 transition-all flex items-center gap-3 bg-white/80 backdrop-blur-sm hover:shadow-lg hover:shadow-violet-500/10">
                <div className="w-10 h-10 rounded-full bg-gradient-to-br from-gray-100 to-gray-200 flex items-center justify-center group-hover:from-violet-100 group-hover:to-violet-100 transition-all">
        ...
        <div className="max-w-6xl mx-auto relative">
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-20">
            {[
              ...
              { step: '03', icon: Sparkles, title: 'Get Actionable Insights', desc: 'Search in natural language, set renewal alerts, and let AI answer questions instantly.', stat: 'Instant results', gradient: 'from-violet-500 to-purple-500' },
            ].map((item, i) => (
              <TiltCard key={i}>
                <div className="relative group h-full">
                    ...
                    {[
                      ...
                      <div key={i} className="flex items-center gap-3 text-sm group cursor-default">
                        <div className="w-6 h-6 rounded-lg bg-gradient-to-br from-violet-500 to-purple-500 flex items-center justify-center flex-shrink-0 shadow-sm group-hover:scale-110 group-hover:shadow-violet-500/30 transition-all">
                          <Check aria-hidden="true" className="w-3.5 h-3.5 text-white" />
                        </div>
                  ...
                  <div className="relative bg-gradient-to-br from-gray-900 via-gray-900 to-gray-800 rounded-2xl overflow-hidden shadow-2xl">
                    ...
                    <div className="p-6">
                      <div className="text-sm font-mono leading-loose">
                        ...
                        <div className="pl-4"><span className="text-violet-400">&quot;startDate&quot;</span><span className="text-gray-500">:</span> <span className="text-violet-400">&quot;2024-01-15&quot;</span><span className="text-gray-500">,</span></div>
                        <div className="pl-4"><span className="text-violet-400">&quot;endDate&quot;</span><span className="text-gray-500">:</span> <span className="text-violet-400">&quot;2025-01-14&quot;</span><span className="text-gray-500">,</span></div>
                        <div className="pl-4"><span className="text-violet-400">&quot;autoRenewal&quot;</span><span className="text-gray-500">:</span> <span className="text-violet-400">true</span><span className="text-gray-500">,</span></div>
                        <div className="pl-4"><span className="text-violet-400">&quot;riskScore&quot;</span><span className="text-gray-500">:</span> <span className="text-orange-400">72</span><span className="text-gray-500">,</span></div>
                        <div className="pl-4"><span className="text-violet-400">&quot;obligations&quot;</span><span className="text-gray-500">:</span> <span className="text-violet-400">12</span><span className="text-gray-500">,</span></div>
                        <div className="pl-4"><span className="text-violet-400">&quot;missingClauses&quot;</span><span className="text-gray-500">:</span> <span className="text-rose-400">[&quot;liability_cap&quot;]</span></div>
                        <div className="text-gray-500">{'}'}</div>
                      </div>
                    </div>
                  </div>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-start">
            ...
            <div>
              <AIPipelineStep 
                ...
                description="Contracts are uploaded and processed through our advanced OCR engine. Whether it's a scanned PDF, Word document, or image, we extract every character with high accuracy."
                icon={FileSearch}
              />
              <AIPipelineStep 
                step={2}
              ...
              <AIPipelineStep 
                ...
                description="Using transformer-based models, we understand the context and meaning of contract language—not just keywords. This enables true semantic search."
                icon={Lightbulb}
              />
              <AIPipelineStep 
                step={4}
              ...
              <div className="relative bg-gradient-to-br from-gray-900 via-gray-900 to-gray-800 rounded-3xl p-8 text-white sticky top-24 overflow-hidden">
                ...
                <div className="relative">
                  ...
                  <div className="space-y-4 mb-8">
                    {[
                      { label: 'Entity Extraction', value: 95, color: 'from-violet-500 to-purple-400' },
                      { label: 'Clause Classification', value: 90, color: 'from-violet-500 to-purple-400' },
                      { label: 'Risk Detection', value: 85, color: 'from-amber-500 to-orange-400' },
                    ].map((item, i) => (
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              { 
                ...
                features: ['256-bit encryption', 'Compliance-ready', 'Audit logging']
              },
            ].map((item, i) => (
                ...
                <ul className="space-y-2">
                  {item.features.map((f, j) => (
                    <li key={j} className="flex items-center gap-2 text-sm text-gray-500">
                      <Check aria-hidden="true" className="w-4 h-4 text-violet-500" />
                      {f}
                    </li>
                  ))}
                </ul>
              ...
              <div className="space-y-4">
                ...
                <div className="flex flex-wrap gap-2">
                  {[
                    ...
                    '"What are our obligations under this MSA?"',
                  ...
                  <div className="flex justify-start">
                    <div className="bg-white border border-gray-100 px-5 py-4 rounded-2xl rounded-bl-md max-w-[85%] shadow-lg">
                      ...
                      <div className="space-y-2 text-sm">
                        {[
                          { name: 'Vendor A - MSA', date: 'Jan 28', urgent: false },
                          { name: 'Partner B - SLA', date: 'Feb 5', urgent: false },
                          { name: 'Client C - NDA', date: 'Feb 12', urgent: true },
                        ].map((contract, i) => (
                      ...
                      <div className="flex items-center gap-3 mb-6">
                        ...
                        <div>
                          ...
                          <span className="text-xs text-violet-600 font-semibold uppercase tracking-wide flex items-center gap-1">
                            <Sparkles aria-hidden="true" className="w-3 h-3" /> AI-Powered
                          </span>
                        </div>
                      </div>
                      <ul className="space-y-4">
      ...
      <section id="security" className="py-32 px-6 bg-gradient-to-br from-gray-950 via-gray-900 to-gray-950 text-white relative overflow-hidden">
        ...
        <div className="absolute inset-0">
          ...
          <div className="absolute bottom-0 left-0 w-[600px] h-[600px] bg-violet-500/10 rounded-full blur-3xl animate-pulse" style={{ animationDuration: '6s', animationDelay: '2s' }} />
        ...
        <div className="max-w-7xl mx-auto relative">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <div className="space-y-4">
                {[
                  { icon: Lock, title: 'AES-256 Encryption', desc: 'Strong encryption for all data at rest and in transit', color: 'from-violet-500 to-purple-500' },
                  { icon: Shield, title: 'Compliance-Ready', desc: 'Architecture designed for SOC 2, ISO 27001, and GDPR requirements', color: 'from-violet-500 to-purple-500' },
            ...
            <div className="relative group">
              ...
              <div className="relative bg-gradient-to-br from-gray-800/80 to-gray-900/80 backdrop-blur-xl p-8 rounded-3xl border border-white/10 shadow-2xl">
                ...
                <div className="mt-6 pt-6 border-t border-white/10 grid grid-cols-3 gap-4 text-center">
                  <div>
                    <div className="text-xl font-bold text-violet-400">AES-256</div>
                    <div className="text-xs text-gray-500">Encryption</div>
                  </div>
                  <div>
                    <div className="text-xl font-bold text-violet-400">MFA</div>
                    <div className="text-xs text-gray-500">Required</div>
                  </div>
                  <div>
                    <div className="text-xl font-bold text-violet-400">Audit</div>
                    <div className="text-xs text-gray-500">Logging</div>
                  </div>
                </div>
              </div>
            </div>
