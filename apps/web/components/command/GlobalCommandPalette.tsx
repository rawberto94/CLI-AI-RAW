  ...
  const useCases: SearchResult[] = [
    {
      ...
      description: '15x ROI • $186K savings/contract',
      icon: DollarSign,
    ...
    },
    {
      ...
      description: '12x ROI • $890K/year savings',
      icon: Calendar,
    ...
    },
    {
      ...
      description: '20x ROI • $890K risk avoided',
      icon: Shield,
    ...
    },
    {
      ...
      description: '15x ROI • $2.1M bundling',
      icon: Network,
    ...
    },
    {
      ...
      description: '8.4x ROI • $2.56M pipeline',
      icon: TrendingUp,
    ...
    },
    {
      ...
      description: '18x ROI • $1.03M/year',
      icon: Database,
    ...
    },
    {
      ...
      description: '25x ROI • $186K/supplier',
      icon: Users,
