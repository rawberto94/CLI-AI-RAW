...
const ChatHeader = memo(({
  ...
  <div className="flex items-center justify-between px-4 py-3 border-b border-slate-200 dark:border-slate-700 bg-gradient-to-r from-violet-600 to-purple-600">
    ...
    <div className="p-4 space-y-4">
      ...
      <div className="flex items-center justify-between">
        ...
        <button
          ...
          className={cn(
            "w-11 h-6 rounded-full transition-colors relative",
            settings.showSuggestions ? "bg-violet-600" : "bg-slate-300 dark:bg-slate-600"
          )}
        >
          <span className={cn(
            "absolute top-0.5 left-0.5 w-5 h-5 bg-white rounded-full transition-transform",
      ...
      <div className="flex items-center justify-between">
        ...
        <button
          ...
          className={cn(
            "w-11 h-6 rounded-full transition-colors relative",
            settings.compactMode ? "bg-violet-600" : "bg-slate-300 dark:bg-slate-600"
          )}
        >
          <span className={cn(
            "absolute top-0.5 left-0.5 w-5 h-5 bg-white rounded-full transition-transform",
...
const WelcomeScreen = memo(({ onSuggestionClick }: { onSuggestionClick: (text: string) => void }) => (
  <div className="flex-1 flex flex-col items-center justify-center p-6 text-center">
    <motion.div
      ...
      className="p-4 bg-gradient-to-br from-violet-500 to-purple-600 rounded-2xl mb-6"
    >
      ...
      >
        ...
        {isLoading && !streamingMessage && (
          <div className="flex items-start gap-3">
            <div className="p-2 bg-gradient-to-br from-violet-500 to-purple-600 rounded-lg shrink-0">
              <Bot className="h-5 w-5 text-white" />
            </div>
