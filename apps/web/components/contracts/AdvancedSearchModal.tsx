...
import { slideInRight } from "@/lib/contracts/animations";
import {
...
export function AdvancedSearchModal({
  ...
  const toggleArrayValue = (
    key: "statuses" | "types" | "riskLevels" | "tags",
    value: string
  ) => {
      ...
      {isOpen && (
        <>
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            <motion.div
              variants={slideInRight as Variants}
              initial="initial"
              animate="animate"
              exit="exit"
              ...
              <div className="flex-1 overflow-y-auto p-6 space-y-6">
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      updateCriteria("query", e.target.value || undefined)
                    }
                  ...
                  <div className="flex flex-wrap gap-2">
                    {RISK_LEVEL_OPTIONS.map((option) => (
                      <button
                        key={option.value}
                        onClick={() =>
                          toggleArrayValue("riskLevels", option.value)
                        }
                        className={cn(
                          "px-3 py-1.5 rounded-lg text-sm font-medium transition-colors",
                      ...
                      <input
                        ...
                        value={
                          criteria.dateRange?.from
                            ? format(criteria.dateRange.from, "yyyy-MM-dd")
                            : ""
                        }
                        onChange={(e) => {
                      ...
                      <input
                        ...
                        value={
                          criteria.dateRange?.to
                            ? format(criteria.dateRange.to, "yyyy-MM-dd")
                            : ""
                        }
                        onChange={(e) => {
                          const date = e.target.value
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      updateCriteria("parties", e.target.value || undefined)
                    }
