...
const CATEGORY_COLORS: Record<string, string> = {
  master_framework: 'bg-violet-100 text-violet-800 dark:bg-violet-900 dark:text-violet-200',
  ...
  software_cloud: 'bg-violet-100 text-violet-800 dark:bg-violet-900 dark:text-violet-200',
  partnerships_jv: 'bg-violet-100 text-indigo-800 dark:bg-violet-900 dark:text-indigo-200',
