          ...
          <div className="flex items-start justify-between">
            <div className="min-w-0 flex-1">
              <Badge 
                ...
                className={cn(
                  "text-[10px] mb-1",
                  position === 'A' ? "border-indigo-200 text-purple-600" : "border-purple-200 text-purple-600"
                )}
              >
                Contract {position}
              </Badge>
            ...
            {filteredContracts.length === 0 ? (
              ...
              filteredContracts.map(contract => (
                <button
                  ...
                  className="w-full text-left p-3 rounded-lg border border-slate-200 hover:border-indigo-300 hover:bg-purple-50/50 transition-all"
                >
                    ...
                    <Tooltip>
                      <TooltipTrigger asChild>
                        <button
                          ...
                          className="p-2 text-slate-400 hover:text-purple-500 hover:bg-slate-100 rounded-lg transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                        >
