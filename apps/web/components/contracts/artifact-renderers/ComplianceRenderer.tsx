...
export const ComplianceRenderer = memo(function ComplianceRenderer({ data }: ComplianceRendererProps) {
  return (
    <div className="space-y-5">
      {data.summary && (
        <div className="p-6 bg-gradient-to-br from-purple-50 to-purple-50 dark:from-purple-950/50 dark:to-purple-950/50 rounded-xl border-2 border-indigo-200 dark:border-indigo-800 shadow-sm">
          ...
          {data.compliance.map((item, i) => (
            <div key={i} className="flex items-start gap-4 p-6 bg-white dark:bg-gray-800 rounded-xl border-2 shadow-sm hover:shadow-md transition-shadow">
              ...
              <div className="flex-1">
                ...
                {item.excerpt && (
                  <p className="text-sm italic text-gray-500 dark:text-gray-400 mt-3 pl-4 border-l-4 border-indigo-300 dark:border-purple-700 leading-relaxed">
