...
export function generateDemoInsights(count: number = 8): AIInsight[] {
  const templates: Array<Omit<AIInsight, 'id' | 'generatedAt' | 'confidence'>> = [
    {
      category: 'risk',
      priority: 'critical',
      title: '3 contracts have unusual liability clauses',
      description: 'AI detected liability caps significantly below industry standards in recent vendor agreements. Review recommended before signing.',
      metric: { value: 250000, label: 'potential exposure', unit: '', change: undefined },
      affectedContracts: 3,
      action: { label: 'Review', href: '/contracts?filter=liability-risk' },
    },
    {
      category: 'opportunity',
      priority: 'high',
      title: 'Volume discount opportunity detected',
      description: 'Consolidating similar services from 4 vendors could yield 15-20% savings based on rate analysis.',
      metric: { value: 85000, label: 'potential savings', unit: '', change: undefined },
      affectedContracts: 4,
      action: { label: 'Analyze', href: '/analytics/savings' },
    },
    {
      category: 'compliance',
      priority: 'medium',
      title: 'GDPR clauses missing in 5 contracts',
      description: 'Data processing agreements with EU-based vendors are missing required GDPR compliance language.',
      affectedContracts: 5,
      action: { label: 'Fix', href: '/contracts?filter=gdpr-missing' },
    },
    {
      category: 'trend',
      priority: 'low',
      title: 'Contract cycle time improving',
      description: 'Average time from draft to signature decreased by 23% over the last quarter.',
      metric: { value: 12, label: 'days avg', unit: '', change: -23 },
    },
    {
      category: 'optimization',
      priority: 'medium',
      title: 'Duplicate clauses detected',
      description: 'Similar indemnification language appears in 12 contracts with minor variations. Consider standardizing.',
      affectedContracts: 12,
      action: { label: 'Standardize', href: '/templates' },
    },
    {
      category: 'alert',
      priority: 'high',
      title: 'Auto-renewal deadline approaching',
      description: '2 high-value contracts will auto-renew in 15 days without action. Combined value: $320,000.',
      metric: { value: 15, label: 'days remaining', unit: '', change: undefined },
      affectedContracts: 2,
      action: { label: 'Review', href: '/renewals?urgent=true' },
    },
    {
      category: 'risk',
      priority: 'medium',
      title: 'Payment terms inconsistency',
      description: 'AI found varying payment terms (Net 30, Net 45, Net 60) across similar vendor contracts.',
      affectedContracts: 8,
    },
    {
      category: 'opportunity',
      priority: 'low',
      title: 'Price benchmark available',
      description: 'New market data suggests current SaaS pricing is 12% above median. Renegotiation opportunity.',
      metric: { value: 12, label: 'above market', unit: '%', change: undefined },
      affectedContracts: 6,
    },
  ]
...
export function generateDemoMetrics(): AIMetrics {
  return {
    extractionAccuracy: 94.5,
    riskDetectionRate: 87.2,
    processingSpeed: 24,
    costSavingsIdentified: 245000,
