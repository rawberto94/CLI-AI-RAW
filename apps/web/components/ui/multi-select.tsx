  ...
  return (
    <div className={cn("relative", className)}>
      ...
      >
        ...
        {selected.length > 0 && (
          <span className="ml-1 inline-flex items-center justify-center px-1.5 py-0.5 text-[10px] rounded bg-purple-100 text-purple-700">
            {selected.length}
          </span>
        )}
                    ...
                    <li key={opt}>
                      <button
                        ...
                        className={cn(
                          ...
                          active ? "bg-purple-50 dark:bg-purple-900/20" : "hover:bg-gray-50 dark:hover:bg-gray-800"
                        )}
                        role="option"
