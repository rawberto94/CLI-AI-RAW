...
CREATE INDEX "ContractEmbedding_embedding_hnsw_idx"
...
CREATE INDEX IF NOT EXISTS "ContractEmbedding_chunkType_idx"
  ON "ContractEmbedding" ("chunkType");

CREATE INDEX IF NOT EXISTS "ContractEmbedding_section_idx"
  ON "ContractEmbedding" ("section")
...
CREATE INDEX IF NOT EXISTS "ContractEmbedding_tenantId_idx"
  ON "ContractEmbedding" ("tenantId");
...
CREATE INDEX IF NOT EXISTS "ContractEmbedding_contractType_idx"
  ON "ContractEmbedding" ("contractType")
