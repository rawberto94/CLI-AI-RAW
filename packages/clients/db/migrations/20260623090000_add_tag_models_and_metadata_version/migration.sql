-- Add first-class tagging/grouping models and Contract.metadataVersion.
-- This is idempotent: safe for environments where the previous raw-SQL migration
-- (scripts/migrations/add-tag-models.sql + add-metadata-version.sql) already ran,
-- as well as fresh databases.
...
-- Contract.metadataVersion (optimistic locking) ------------------------------
