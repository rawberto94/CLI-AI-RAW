...
-- CreateIndex
CREATE UNIQUE INDEX "market_rate_intelligence_tenantId_roleStandardized_seniorit_key" ON "market_rate_intelligence"("tenantId", "roleStandardized", "seniority", "country", "periodStart");
...
-- CreateIndex
CREATE INDEX "rate_savings_opportunities_category_idx" ON "rate_savings_opportunities"("category");
