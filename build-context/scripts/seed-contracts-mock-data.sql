...
-- This populates all key tables with realistic demo data

-- 1. Create demo tenant if not exists
INSERT INTO "Tenant" (id, name, "createdAt", "updatedAt")
VALUES ('demo-tenant', 'Demo Organization', NOW(), NOW())
...
VALUES
    ('ratecard-accenture', 'demo-tenant', 'import-accenture', 'supplier-accenture', 
     'Accenture', 'BIG_4', '2024-01-01', '2025-12-31', 'USD', 'USD',
     'CSV Import', 'admin@demo.com', 'ACTIVE', 
     '{"completeness": 100, "consistency": 95, "accuracy": 98}'::jsonb),
    
    ('ratecard-thoughtworks', 'demo-tenant', 'import-thoughtworks', 'supplier-thoughtworks',
     'Thoughtworks', 'BOUTIQUE', '2024-01-01', '2025-12-31', 'USD', 'USD',
     'CSV Import', 'admin@demo.com', 'ACTIVE',
     '{"completeness": 100, "consistency": 97, "accuracy": 99}'::jsonb),
    
    ('ratecard-infosys', 'demo-tenant', 'import-infosys', 'supplier-infosys',
     'Infosys', 'OFFSHORE', '2024-01-01', '2025-12-31', 'INR', 'USD',
     'CSV Import', 'admin@demo.com', 'ACTIVE',
     '{"completeness": 100, "consistency": 96, "accuracy": 97}'::jsonb),
    
    ('ratecard-deloitte', 'demo-tenant', 'import-deloitte', 'supplier-deloitte',
