      ...
      >
        <div className="relative">
          <motion.div
            ...
            className="w-20 h-20 rounded-2xl bg-gradient-to-br from-red-500 via-orange-500 to-amber-500 flex items-center justify-center shadow-2xl shadow-red-500/30"
          >
        ...
        >
          <h2 className="text-xl font-semibold bg-gradient-to-r from-red-600 to-orange-600 bg-clip-text text-transparent">
            Loading Deadlines
          </h2>
          <p className="text-sm text-slate-500 mt-2">Fetching upcoming deadlines...</p>
        </motion.div>
