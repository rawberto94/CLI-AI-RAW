...
export default function PrivacyPage() {
  return (
    <div className="bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
              ...
              <ul className="space-y-3">
                {section.content.map((item, i) => (
                  <li key={i} className="flex items-start gap-3">
                    <div className="w-1.5 h-1.5 bg-violet-400 rounded-full mt-2.5 flex-shrink-0" />
      ...
      <section className="py-16">
        <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
          <div className="bg-gradient-to-br from-violet-500/20 to-purple-500/10 border border-white/10 rounded-2xl p-8 text-center">
            <Mail className="w-12 h-12 text-violet-400 mx-auto mb-4" />
            <h2 className="text-2xl font-bold text-white mb-4">Questions About Privacy?</h2>
            <p className="text-slate-300 mb-6">
              Contact our Data Protection Officer at{' '}
              <a href="mailto:privacy@contigo.io" className="text-violet-400 hover:text-violet-300">
                privacy@contigo.io
              </a>
            </p>
            <Link
