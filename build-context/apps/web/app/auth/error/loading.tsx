...
import { AlertTriangle, Shield, RefreshCw, HelpCircle } from 'lucide-react';
      ...
      <div className="flex flex-col items-center">
        ...
        <div className="relative">
          <motion.div
            ...
            className="w-20 h-20 rounded-2xl bg-gradient-to-br from-red-500 via-rose-500 to-orange-500 shadow-2xl shadow-red-500/30 flex items-center justify-center"
          >
        ...
        >
          ...
          <p className="text-sm text-muted-foreground mt-1">Retrieving error information...</p>
