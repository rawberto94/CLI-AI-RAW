      ...
      <div className="flex flex-col items-center">
        ...
        <div className="relative">
          <motion.div
            ...
            className="w-20 h-20 rounded-2xl bg-gradient-to-br from-violet-500 via-violet-500 to-purple-600 shadow-2xl shadow-green-500/30 flex items-center justify-center"
          >
