...
/**
 * Error Boundary for Intelligence Suite
  ...
  return (
    <div className="flex items-center justify-center min-h-[60vh]">
      <div className="max-w-md w-full mx-4 text-center space-y-6">
        ...
        <div>
          <h2 className="text-xl font-semibold mb-2">Intelligence Module Error</h2>
          <p className="text-muted-foreground text-sm">
            Something went wrong while loading the intelligence dashboard. Please try again.
          </p>
        </div>
