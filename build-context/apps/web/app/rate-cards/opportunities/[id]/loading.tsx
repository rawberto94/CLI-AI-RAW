...
import { Target, Lightbulb, DollarSign, Eye } from 'lucide-react';
      ...
      >
        <div className="relative">
          <motion.div
            ...
            className="w-20 h-20 rounded-2xl bg-gradient-to-br from-amber-500 via-amber-600 to-yellow-500 flex items-center justify-center shadow-2xl shadow-amber-500/30"
          >
        ...
        >
          ...
          <p className="text-sm text-slate-500 mt-2">Fetching opportunity data...</p>
        </motion.div>
        ...
        <div className="flex items-center justify-center gap-2 mt-6">
          {[0, 1, 2].map((i) => (
            <motion.div
              ...
              className="w-2 h-2 rounded-full bg-gradient-to-r from-amber-500 to-yellow-500"
            />
          ))}
        </div>
      </motion.div>
