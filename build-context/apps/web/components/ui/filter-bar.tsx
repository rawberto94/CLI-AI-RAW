                ...
                {suppliers.length === 0 ? (
                  ...
                  <button
                    ...
                    className={cn(
                      ...
                      (value as any).supplier === s ? "bg-violet-600 text-white border-violet-600" : "bg-white dark:bg-gray-800 text-gray-800 dark:text-gray-100 border-gray-300 dark:border-gray-600 hover:bg-gray-50"
                    )}
                  >
                    {s}
                  </button>
              ...
              <div className="flex flex-wrap gap-2">
                {types.map((t) => (
                  <button
                    ...
                    className={cn(
                      "px-2 py-1 text-xs rounded-full border",
                      (value as any).type === t ? "bg-violet-600 text-white border-violet-600" : "bg-white dark:bg-gray-800 text-gray-800 dark:text-gray-100 border-gray-300 dark:border-gray-600 hover:bg-gray-50"
                    )}
                  >
                    {t}
                  </button>
              ...
              <div className="flex flex-wrap gap-2">
                {statuses.map((st) => (
                  <button
                    ...
                    className={cn(
                      "px-2 py-1 text-xs rounded-full border",
                      (value as any).status === st ? "bg-violet-600 text-white border-violet-600" : "bg-white dark:bg-gray-800 text-gray-800 dark:text-gray-100 border-gray-300 dark:border-gray-600 hover:bg-gray-50"
                    )}
                  >
                    {st}
                  </button>
              ...
              <div className="flex flex-wrap gap-2">
                {categories.map((cat) => (
                  <button
                    ...
                    className={cn(
                      "px-2 py-1 text-xs rounded-full border",
                      (value as any).category === cat ? "bg-violet-600 text-white border-violet-600" : "bg-white dark:bg-gray-800 text-gray-800 dark:text-gray-100 border-gray-300 dark:border-gray-600 hover:bg-gray-50"
                    )}
                  >
                    {cat}
                  </button>
      ...
      {showBadges && (
        <div className="flex flex-wrap items-center gap-2">
          ...
          {toArray(value.client).length > 0 && (
            <span className="px-2 py-1 text-xs rounded bg-violet-50 text-violet-700">Client: {toArray(value.client).join(", ")}</span>
          )}
          {toArray(value.supplier).length > 0 && (
            <span className="px-2 py-1 text-xs rounded bg-violet-50 text-violet-700">Supplier: {toArray(value.supplier).join(", ")}</span>
          )}
          {toArray(value.type).length > 0 && (
            <span className="px-2 py-1 text-xs rounded bg-violet-50 text-violet-700">Type: {toArray(value.type).join(", ")}</span>
          )}
          {toArray(value.status).length > 0 && (
            <span className="px-2 py-1 text-xs rounded bg-violet-50 text-violet-700">Status: {toArray(value.status).join(", ")}</span>
          )}
          {toArray(value.category).length > 0 && (
            <span className="px-2 py-1 text-xs rounded bg-violet-50 text-violet-700">Category: {toArray(value.category).join(", ")}</span>
          )}
        </div>
      )}
    </div>
