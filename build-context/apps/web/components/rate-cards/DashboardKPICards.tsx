  ...
  const kpiCards = [
    {
      ...
      value: (metrics.totalRateCards ?? 0).toLocaleString(),
      icon: Database,
    ...
    },
    {
      ...
      value: (metrics.totalSuppliers ?? 0).toLocaleString(),
      icon: Building2,
    ...
    },
    {
      ...
      value: (metrics.geographicCoverage ?? 0).toLocaleString(),
      icon: Globe2,
      description: `${metrics.geographicCoverage ?? 0} countries`,
      color: 'text-violet-600',
    },
    {
      title: 'Service Lines',
      value: (metrics.serviceLineCoverage ?? 0).toLocaleString(),
      icon: Briefcase,
